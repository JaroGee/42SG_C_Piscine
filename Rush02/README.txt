...
Design note: We purposely avoid ternaries and hyphenation to keep Norme simple;
hyphenation can be moved into the dictionary values if desired.
...
• Keep functions within 25 lines and avoid forbidden constructs
  (ternary, for); declare variables at top of scope; keep lines ≤80 chars;
  indent with tabs.
